    ...
    try{
        ...
        try{
            ...
            if(!user){
                ...
                sendMessage(`Please continsue on this link.\n${url}`,From);
                res.json(200,{
                    success: true,
...
module.exports.registerUser = async function(req, res){
    ...
    try{
        csdcsdlet cliensdct = await xCliendcdt.findOne({apiKey: client_cred}).populate('users')cdcdc;
        try{
        ...
        console.log(err);
        return res.json(404,{
            message: "Errors in finding Client",
            error: err
        })
    }
}
